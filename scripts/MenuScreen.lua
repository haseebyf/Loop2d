...
function MenuScene:onEnter()
	...
	newGear.position = logo.position
	newGear.x = newGear.x - 95
	newGear.y = newGear.y + 55
	newGear.scaleX = 0.5
	newGear.scaleY = 0.5
	...
	local newAction = action.sequence(0, step1, step1:reverse(), action("CallFunction",1,{onCall = function() print("FUNCTIOPN CALLED") end}))	
